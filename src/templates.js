export const certificateTypes = [
    { id: 'fp-aluno', group: 'Feira de Profissões', label: 'Aluno participante', file: 'fp-aluno.pdf', fields: { unidade: 'text_10a2j', nome: 'text_29x9p', localData: 'text_34j4z' } },
    { id: 'fp-comissao', group: 'Feira de Profissões', label: 'Comissão organizadora', file: 'fp-comissao.pdf', fields: { unidade: 'text_12y0h', nome: 'text_22z7y', localData: 'text_38z5h' } },
    { id: 'fc-participante', group: 'Feira de Ciências', label: 'Aluno participante', file: 'fc-participante.pdf', fields: { unidade: 'text_18g0i', nome: 'text_26l5d', localData: 'text_37v4t' } },
